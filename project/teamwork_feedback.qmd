...
Overall, the team worked fairly well together. I think we all contributed evenly towards the project worked effectively to meet the deadlines of the project. 
My role included initiating group meetings and kickstarting each milestone hand-in. I thoroughly read through the milestone guidelines on the course website as well as the feedback given from our previous submission. I then bring these before the team as tasks that needs to be addressed and delegated. I was also involved in revising and making final edits and checks before each submission. I think amongst the 4 of us, the workload was pretty even with Aidan and Adrian taking more of the coding elements, especially when it comes to helping Yujia and I in debugging our code. Aidan was also an initiator in the group for starting up brainstorming and discussions for upcoming submissions.
